...
class Priority_Queue:
    ...
    def remove(self):
        ...
        val = self._values.pop(self._first)
    ...
    def split_alt(self):
        ...
        target2 = Priority_Queue()
        while not self.is_empty():
            target1._values.append(self._values.pop(self._first))
            self._set_first()
            if not self.is_empty():
                target2._values.append(self._values.pop(self._first))
                self._set_first()
