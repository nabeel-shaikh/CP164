...
class List:
    ...
    def _linear_search(self, key):
        ...
        index = 0
        x = False
        while index < len(self._values) and x is False:
    ...
    def clean(self):
        ...
        for x in self._values:
            if x not in clean_lst:
                clean_lst.append(x)
        self._values = clean_lst
    ...
    def combine(self, source1, source2):
        ...
        """
        while len(source1) != 0:
            self.append(source1.pop(-1))
            if len(source2) != 0:
                self.append(source2.pop(-1))
        while len(source2) != 0:
            self.append(source2.pop(-1))
    ...
    def is_identical(self, target):
        ...
        if len(self) != len(target):
            ...
            x = 0
            check = True
            while x< len(self) and check is True:
    ...
    def max(self):
        ...
        highest = deepcopy(self._values[0])
        for x in self._values:
            if x> highest:
                highest = deepcopy(x)
    ...
    def min(self):
        ...
        lowest = deepcopy(self._values[0])
        for x in self._values:
            if x< lowest:
                lowest = deepcopy(x)
    ...
    def remove(self, key):
        ...
        if key in self._values:
            key_index = self._linear_search(key)
            return self._values.pop(key_index)
        else:
            return None
    ...
    def split(self):
        ...
        -------------------------------------------------------
        """
        length = len(self._values)//2 
        target1 = self._values[:length]
        target2 = self._values[length:]
    ...
    def split_alt(self):
        ...
        while not len(self._values) == 0:
            target1.append(self._values.pop(-1))
            if len(self._values) != 0:
                target2.append(self._values.pop(-1))
